...
public class FingerprintAuthService extends Service {
    private static final String KEY_NAME = "mySecureKey";
...
//            textView.setText("Please enable lockscreen security in your device's Settings");
            ...
            try {
                generateKey();
            } catch (FingerprintAuthService.FingerprintException e) {
                e.printStackTrace();
            }
    ...
    private void generateKey() throws FingerprintAuthService.FingerprintException {
        try {
            ...
            exc.printStackTrace();
            throw new FingerprintAuthService.FingerprintException(exc);
        }
    }
